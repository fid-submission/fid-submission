...
and arithmop = ADC | ADD | XADD | SUB | ADDL | ADDQ | SUBL | SUBQ
               ...
               | PSUBD | PSUBW | PSUBB | MULPD | UNPCKHPD | ADDPS | MULPS | PSUBQ
...
and rolop = ROL | SHL | SHR | SHLD |SHRD | SHRL | ROR | RORL
            ...
            | PSRLD | PSHUFLW | PSRLW | PSRLQ
and assignop = MOV | XCHG | LEA | MOVSX | MOVSD | MOVL | FLDL | MOVZBL | MOVZBW
               | MOVSW | MOVAPD | MOVSLQ | MOVQ | MOVABS | MOVSBQ | MOVSL | MOVMSKPD 
               ...
               | REP | FNSTSW | CMOVLE | CMOVG | CMOVL | FILDLL | FIADDL
               ...
               | PUNPCKLQDQ | PUNPCKLWD | MOVHPD | MOVLPD | MOVNTQ
               | LAHF | SAHF | STMXCSR | LDMXCSR | PMOVMSKB | MOVNTDQ | EMMS
               | XGETBV | FXSAVE | PUNPCKHDQ | MOVMSKPS | MOVLPS | MOVHPS
and compareop = CMP | CMPQ | TEST | CMPL | CMPB | CMPW | TESTB | TESTL | CMPSB
                | BT | TESTW | CMPNLESS | CMPLTSS | CMPNLTSS | TESTQ | BTR | BTS
                | BTC | CMPEQSD
                | CMPNLTSD | PCMPGTD | PCMPGTB | PCMPEQD | CMPLTSD | PCMPEQW
                | CMPEQSS | PCMPEQB | COMISD | CMPLESD | CMPLESS
and setop = SETA | SETAE | SETB | SETBE | SETC
            | SETNBE | SETNC | SETNG | SETNE
            | SETE | SETNP | SETGE | SETG | SETLE
            | SETL | SETP | SETNS | SETS
and otherop = NOP | HLT | NOPW | NOPL | UD2 | LOAD | STORE | LOADL | STOREL
...
and bblock =
 ...
 (* TODO: we didn't distuigsh indirect jmp with indirect call *)
