...
and remove_bracket s' =
  ...
  and arithm_symb = function
    ...
    | "divpd" -> DIVPD | "divps" -> DIVPS | "divb" -> DIVB
    | "mulps" -> MULPS
    ...
    | "incq" -> INCQ
    | "dec" -> DEC | "neg" -> NEG | "negl" -> NEGL | "negb" -> NEGB
    | "decl" -> DECL | "fdiv" -> FDIV | "decb" -> DECB
    | "decd" -> DECD | "decw" -> DECW
    | "sbb" -> SBB | "fadd" -> FADD | "fxch" -> FXCH | "subl" -> SUBL | "subsd" -> SUBSD
    | "subq" -> SUBQ | "fucom" -> FUCOM | "fucomp" -> FUCOMP | "bsf" -> BSF
    | "fucomip" -> FUCOMIP | "fucomi" -> FUCOMI | "bsr" -> BSR | "divl" -> DIVL
    | "ucomisd" -> UCOMISD | "ucomiss" -> UCOMISS | "fucompp" -> FUCOMPP
    ...
    | "cvtdq2ps" -> CVTDQ2PS | "cvttps2dq" -> CVTTPS2DQ | "fcomp" -> FCOMP
    | "maxsd" -> MAXSD | "negq" -> NEGQ | "idivq" -> IDIVQ | "fcom" -> FCOM
  ...
  and rolop_symb = function
    ...
    | "psrldq" -> PSRLDQ | "psrld" -> PSRLD | "psrlw" -> PSRLW | "psrlq" -> PSRLQ
  ...
  and assignop_symb = function
    ...
    | "fstpt" -> FSTPT | "fstps" -> FSTPS | "fsts" -> FSTS | "movsl" -> MOVSL
    ...
    | "movzwl" -> MOVZWL | "movswl" -> MOVSWL | "repnz" -> REPNZ | "fildll" -> FILDLL | "fiaddl" -> FIADDL
  ...
  and compareop_symb = function
    ...
    | "testl" -> TESTL | "cmpsb" -> CMPSB | "bt" -> BT | "btr" -> BTR
  ...
  and systemp_symb = function
    | "int" -> INT | "in" -> IN | "mfence" -> MFENCE | "sfence" -> SFENCE
    | "out" -> OUT
