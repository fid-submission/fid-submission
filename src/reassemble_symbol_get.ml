...
*)
 ...
 (*
2015-04-28 : we need to be fast, otherwise we don't have enough time to evaluate them all!
List.mem with string elements:  around 600s for 600000 * 600000 times.
List.mem with int elements:  around 200s for 600000 * 600000 times.
bbn_byloc addr text_mem_arr in  around 10s for 600000 * 600000 times
*)
