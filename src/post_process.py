...
for i in range(ll):
    ...
    # http://stackoverflow.com/questions/12697081/what-is-gmon-start-symbol
    ...
    # FIXME : jmpq S_0x4006C1 throws warning
    #  Warning: indirect jmp without `*'
    # and the exe crashes at this instruction
...
## there is an excellent blog talking about this
